...
# To call the API, 
# you need to include a key= parameter and provide the address that you are requesting 
# as the address= parameter that is properly URL encoded using the urllib.parse.urlencode() function 
...
# Hint: The first seven characters of the place_id are "ChIJFQb ..."
