...
data_source = open("E:/UNIVERSITY OF MICHIGAN\Python for Everybody Specialization/4 Using Databases with Python/Assignments/3 Musical Track Database/Library.xml")
